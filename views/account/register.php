...
<div class="container col-12 col-md-4" style="min-height: 400px;">
    <h1 class="text-center mt-4">
        Đăng ký tài khoản
    </h1>
    <form action="index.php?page=dang-ky" method="post" class="mt-5">
        ...
        <div class="form-group mt-2">
            <label class="fw-semibold" for="password">Mật khẩu:</label>
            <div class="position-relative">
                <svg style="right: 0; cursor: pointer;" class="eye-open position-absolute top-50 translate-middle" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#000000" version="1.1" id="Capa_1" width="25px" height="25px" viewBox="0 0 442.04 442.04" xml:space="preserve">
                    <g>
                        <g>
                ...
                <svg style="right: 0; cursor: pointer;" class="eye-close position-absolute top-50 translate-middle" xmlns="http://www.w3.org/2000/svg" width="25px" height="25px" viewBox="0 0 24 24" fill="#000000">
        ...
        <br>
        <button type="submit" name="btnRegister" class="btn btn-dark w-100">Đăng ký</button>
    </form>
    <h6 class="mt-3">
